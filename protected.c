...
/*
 * Check of the protected function has been protected yet or not.
 */
bool
is_protected ()
{
 ...
 * significant bits of the pointer to find the nearest start of the page.
 */
void*
...
/*
 * After protected is writable, this xor's each byte of the protected function
 * with the given key.
 */
void
xor_protected (uint32_t key)
{
